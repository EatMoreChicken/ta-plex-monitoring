...
def collect_events(helper, ew):
    ...
    # Construct URL to make the request for server preferences
    url = f"http://{plex_server}:{plex_port}/:/prefs?X-Plex-Token={plex_token}"
    ...
    # Extract the preference elements and output them as separate events
