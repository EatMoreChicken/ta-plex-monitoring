...
def collect_events(helper, ew):
    ...
    # Construct URL to make the request for devices
    url = f"http://{plex_server}:{plex_port}/devices/?X-Plex-Token={plex_token}"
    ...
    # Loop through the device elements in the XML and create an event for each one
