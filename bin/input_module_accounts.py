...
def collect_events(helper, ew):
    ...
    # Construct URL to make the request for accounts
    url = f"http://{plex_server}:{plex_port}/accounts/?X-Plex-Token={plex_token}"
    ...
    # Loop through the account elements in the XML and create an event for each one
